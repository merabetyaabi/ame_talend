...
package local_project.copy_of_toto_ame_0_1;
...
/**
 * Job: Copy_of_toto_ame Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Copy_of_toto_ame implements TalendJob {
	...
	private final String jobName = "Copy_of_toto_ame";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_toto_ame.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_toto_ame.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final Copy_of_toto_ame Copy_of_toto_ameClass = new Copy_of_toto_ame();

		int exitCode = Copy_of_toto_ameClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_toto_ame.class
					.getClassLoader().getResourceAsStream(
							"local_project/copy_of_toto_ame_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_toto_ame.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_toto_ame");
		}
...
/************************************************************************************************
 * 24184 characters generated by Talend Open Studio for Data Integration on the
 * 20 mars 2019 21:24:16 CET
 ************************************************************************************************/
