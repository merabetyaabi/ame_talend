...
package local_project.copy_of_copy_of_titi_0_1;
...
/**
 * Job: Copy_of_Copy_of_titi Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class Copy_of_Copy_of_titi implements TalendJob {
	...
	private final String jobName = "Copy_of_Copy_of_titi";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_Copy_of_titi.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_Copy_of_titi.this, new Object[] {
	...
	public static void main(String[] args) {
		final Copy_of_Copy_of_titi Copy_of_Copy_of_titiClass = new Copy_of_Copy_of_titi();

		int exitCode = Copy_of_Copy_of_titiClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_Copy_of_titi.class
					.getClassLoader().getResourceAsStream(
							"local_project/copy_of_copy_of_titi_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Copy_of_Copy_of_titi");
		}
...
/************************************************************************************************
 * 21717 characters generated by Talend Open Studio for Data Integration on the
 * 20 mars 2019 16:11:27 CET
 ************************************************************************************************/
