...
package local_project.titi_0_1;
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String messagetMsgBox_1 = "Hello world first modif from talend7!";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = titi.class.getClassLoader()
					.getResourceAsStream(
							"local_project/titi_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 21534 characters generated by Talend Open Studio for Data Integration on the
 * 20 mars 2019 22:08:59 CET
 ************************************************************************************************/
