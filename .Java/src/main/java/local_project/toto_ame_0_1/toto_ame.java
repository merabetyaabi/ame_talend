...
package local_project.toto_ame_0_1;
...
/**
 * Job: toto_ame Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class toto_ame implements TalendJob {
	...
	private final String jobName = "toto_ame";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(toto_ame.this, new Object[] { e,
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String messagetMsgBox_1 = "Hello world seconde modification! from talend7";
	...
	public static void main(String[] args) {
		final toto_ame toto_ameClass = new toto_ame();

		int exitCode = toto_ameClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = toto_ame.class.getClassLoader()
					.getResourceAsStream(
							"local_project/toto_ame_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : toto_ame");
		}
...
/************************************************************************************************
 * 21595 characters generated by Talend Open Studio for Data Integration on the
 * 20 mars 2019 21:31:43 CET
 ************************************************************************************************/
