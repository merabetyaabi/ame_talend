...
package local_project.toto_ame_02_0_1;
...
/**
 * Job: toto_ame_02 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class toto_ame_02 implements TalendJob {
	...
	private final String jobName = "toto_ame_02";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(toto_ame_02.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final toto_ame_02 toto_ame_02Class = new toto_ame_02();

		int exitCode = toto_ame_02Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = toto_ame_02.class.getClassLoader()
					.getResourceAsStream(
							"local_project/toto_ame_02_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : toto_ame_02");
		}
...
/************************************************************************************************
 * 21600 characters generated by Talend Open Studio for Data Integration on the
 * 21 mars 2019 15:47:04 CET
 ************************************************************************************************/
